...
# Small Prompt
sp_system_message = json_helper.return_json_information_ut(promptType=PromptType.SYSTEM_SMALL_PROMPT)
sp_prompt = json_helper.return_json_information_ut(promptType=PromptType.SMALL_PROMPT)
sp_model =model
sp_temperature = 0
...
mp_system_message = json_helper.return_json_information_ut(promptType=PromptType.SYSTEM_MEDIUM_PROMPT)
mp_prompt = json_helper.return_json_information_ut(promptType=PromptType.MEDIUM_PROMPT)
mp_model = model
mp_temperature = 0
...
# Large Prompt
lp_system_message = json_helper.return_json_information_ut(promptType=PromptType.SYSTEM_LARGE_PROMPT)
lp_prompt = json_helper.return_json_information_ut(promptType=PromptType.LARGE_PROMPT)
lp_model = model
lp_temperature = 0
